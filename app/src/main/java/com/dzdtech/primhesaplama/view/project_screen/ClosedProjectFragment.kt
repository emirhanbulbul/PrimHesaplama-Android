...
import com.dzdtech.primhesaplama.databinding.FragmentProjectClosedBinding
import com.dzdtech.primhesaplama.viewmodel.ProjectViewModel
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class ClosedProjectFragment : Fragment() {

    private lateinit var binding: FragmentProjectClosedBinding
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_project_closed, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentProjectClosedBinding.bind(view)
        viewModel = ViewModelProvider(this)[ProjectViewModel::class.java]
        val layoutManager = LinearLayoutManager(context)
        binding.projectClosedRecyclerView.layoutManager = layoutManager
        ...
        viewModel.data.observe(viewLifecycleOwner) {
            ...
            binding.projectClosedRecyclerView.adapter = adapter
